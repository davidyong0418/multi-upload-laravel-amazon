...
Route::get('/customers/subscribe/{option}/{artwork_id}', 'CustomersController@subscribe');
Route::post('/customers/subscribe/', 'CustomersController@postSubscribe');
Route::get('/customers/checkout/{package}/{artwork_id}', 'CustomersController@checkout');
...
Route::post('/paycomplete', 'CustomersController@verify');
  ...
  Route::get('/artworks/store/step2', 'ArtworkController@step2');
